...
(function () {
    ...
    var basicBot = {
        ...
        startup: function () {
            ...
            API.chatLog('Olá'/*aqui será adicionado o nome do usuário que iniciou o bot*/', seja bem vindo à minha nova interface traduzida! Agradeça ao V1RTU4L e ao MacacoPregoRoxo por isso.'),
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                      ...
                      if (basicBot.settings.thorCommand){
                        var id = chat.uid,
                              ...
                              thorCd = false,
                              timeInMinutes = 0,
                              worthyAlg = Math.floor(Math.random() * 6),
